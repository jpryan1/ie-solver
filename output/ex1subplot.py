...
for ax_idx in range(3):
	...
	solution_lines = open("output/data/ex1_sol" + str(ax_idx+1)+".txt", "r").readlines()
	boundary_lines = open("output/data/ex1_bound" + str(ax_idx+1)+".txt", "r").readlines()
