...
#ifndef IE_SOLVER_BOUNDARIES_EX4BOUNDARY_H_
#define IE_SOLVER_BOUNDARIES_EX4BOUNDARY_H_
...
class Ex4Boundary : public CubicBoundary {
 public:
...
#endif  // IE_SOLVER_BOUNDARIES_EX4BOUNDARY_H_
